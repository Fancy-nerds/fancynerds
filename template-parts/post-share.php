...
<div class="share-list">
    ...
    <a class="share-link share-link--fb" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?= urlencode($link) ?>" title="Facebook">
    ...
    <a class="share-link share-link--pt" target="_blank" href="https://www.pinterest.com/pin/create/button/?url=<?= urlencode($link) ?>&amp;description=<?= urlencode($title) ?>" title="Pinterest">
        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="pinterest-p" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="svg-inline--fa fa-pinterest-p fa-w-12">
    ...
    <a class="share-link share-link--in" target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?= urlencode($link) ?>&amp;title=<?= urlencode($title) ?>" title="LinkedIn">
